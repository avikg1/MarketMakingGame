  ...
  if (state === 0) {
    inputs = 
      <>
        ...
        <Heading as='h4' size='lg' p='20px' noOfLines={3}>Play <code>The Market Making Game!</code> Enter a game code to join or start a new game.</Heading>
      </>
      renderLogo = logo;
  } else if (state === 1) {
    //admin
    ...
    inputs = 
      <>
        ...
        <br></br>
        <p>Play <code>The Market Making Game</code>! Enter a game code or start a new game.</p>
      </>
      renderLogo = logo;
  } else if (state === 3) {
    //socket.on('gameStartedPlayer', () => {
